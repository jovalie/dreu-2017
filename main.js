...
function init() {
  ...
  c_top.src = "img/joan_top.jpg";
  top_width = 237;
  top_height = 266;
  c_bottom.src = "img/joan_bottom.jpg";
  bottom_width = 190;
  bottom_height = 77;
...
function draw() {
  ...
  ctx.drawImage(
    c_top,
    window.innerWidth / 2 - top_width / 2,
    window.innerHeight / 2 - top_height,
    top_width,
    top_height
  );
  ...
  ctx.drawImage(
    c_bottom,
    window.innerWidth / 2 - bottom_width / 2,
